  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDateFns} localeText={{ start: "Start Date", end: "End Date" }}>
      <Box position="absolute">
        <TextField value={`${dateRange.startDate} - ${dateRange.endDate}`} onClick={handleCalendarToggle} />
        <CalenderIcon onClick={handleCalendarToggle} style={{ width: "25%", margin: "-4% 0% 0% 0%" }} />
        {toggleCalendar && (
          <React.Fragment>
